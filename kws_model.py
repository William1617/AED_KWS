...
class KWSModel(torch.nn.Module):
    ...
    def forward(
      ...
      #  print(encoder_out_lens)
        ...
        if self.ctc_weight != 1.0:
            loss_att = self._calc_att_loss(encoder_out, encoder_mask,
                                                    text, text_lengths)
        else:
            loss_att = None
    ...
    def attention_rescoring(
       ...
       # print(hyps_pad)
        ...
        r_decoder_out = r_decoder_out.detach().numpy()
    ...
    def forward_attention_decoder(
        ...
        decoder_out, _ = self.decoder(
            encoder_out, encoder_mask, hyps, hyps_lens)  # (num_hyps, max_hyps_len, vocab_size)
        decoder_out = torch.nn.functional.log_softmax(decoder_out, dim=-1)
